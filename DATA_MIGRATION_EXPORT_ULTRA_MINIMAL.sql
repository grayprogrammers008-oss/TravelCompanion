-- ============================================================================
-- DATA MIGRATION EXPORT SCRIPT (ULTRA MINIMAL VERSION)
-- ============================================================================
--
...
--
-- ULTRA MINIMAL: Only exports columns that DEFINITELY exist
--                Uses ONLY: id, foreign keys, and essential data
-- ============================================================================

-- Header
SELECT '-- ============================================================================' as import_script;
SELECT '-- DATA IMPORT SCRIPT' as import_script;
SELECT '-- Generated from OLD database (ULTRA MINIMAL)' as import_script;
...
SELECT format(
    'INSERT INTO public.itinerary_items (id, trip_id, title, start_time, end_time, created_by) VALUES (%L, %L, %L, %L, %L, %L) ON CONFLICT (id) DO NOTHING;',
    id,
    trip_id,
    title,
    start_time,
...
SELECT format(
    'INSERT INTO public.expenses (id, trip_id, title, amount, paid_by, date) VALUES (%L, %L, %L, %L, %L, %L) ON CONFLICT (id) DO NOTHING;',
    id,
    trip_id,
    title,
    amount,
