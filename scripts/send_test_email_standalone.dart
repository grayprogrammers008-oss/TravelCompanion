...
/// Standalone script to send test email to vinothvsbe@gmail.com
///
/// Run with: dart run scripts/send_test_email_standalone.dart
void main() async {
  ...
  try {
    ...
    if (accountResponse.statusCode == 200) {
      ...
      print('   Account: ${accountData['email']}');
      print('   Credits: ${accountData['plan'][0]['credits']}/${accountData['plan'][0]['creditsType']}\n');
    } else {
      print('❌ Connection failed: ${accountResponse.statusCode}');
      return;
    }
  } catch (e) {
    print('❌ Error connecting to Brevo: $e');
    return;
  }
...
''';
  ...
  try {
    ...
    if (response.statusCode == 201) {
      ...
      print('');
      print('Please check your inbox (and spam folder) at vinothvsbe@gmail.com');
      print('');
      print('Email Details:');
